...
const Create = () => {
    ...
    const categories = ["science", "sports", "business", "politics", "entertainment", "technology", "world", "all"] //Not use
    ...
    const addPostHandler = () => {
        ...
        if (!userId || !title || !description || !like || !tags) {
            ...
            try {
                fetch('https://dummyjson.com/posts/add', {   // Dummy json api for post
                    method: 'POST',
